...
function SvgTelicon ({ children, ...props }: SvgToJsxProps) {
  return (
    <svg {...props}>
      ...
      <symbol id="arrow-down--circle-o" viewBox="0 0 16 16">
      ...
      <symbol id="arrow-right--circle-o" viewBox="0 0 16 16">
      ...
      <symbol id="avatar--badge" viewBox="0 0 16 16">
        <path d="M6 0h4v2H6z" />
      ...
      <symbol id="avatar--circle" viewBox="0 0 16 16">
      ...
      <symbol id="bar-graph--square" viewBox="0 0 16 16">
        <path d="M0 0v16h16V0H0zm5 13H3V6h2v7zm4 0H7V3h2v10zm4 0h-2V9h2v4z" />
      </symbol>
      <symbol id="bar-graph" viewBox="0 0 16 16">
      ...
      <symbol id="calendar-minus" viewBox="0 0 16 16">
      ...
      <symbol id="carets-sortable" viewBox="0 0 16 16">
      ...
      <symbol id="check--circle-o" viewBox="0 0 16 16">
      ...
      <symbol id="chevron-double-up" viewBox="0 0 16 16">
      ...
      <symbol id="clock-hands" viewBox="0 0 16 16">
        <path d="M9 7.54V2.43A.44.44 0 008.58 2H7.43a.43.43 0 00-.43.43v5.92a.47.47 0 00.18.35l3.05 2.22a.43.43 0 00.61-.1l.68-.93a.42.42 0 00-.1-.6z" />
      </symbol>
      <symbol id="comment-dots" viewBox="0 0 16 16">
      ...
      <symbol id="credit-card-plus" viewBox="0 0 16 16">
      ...
      <symbol id="dashboard-grid" viewBox="0 0 16 16">
        <path d="M1 1h6v4H1V1zm0 6h6v8H1V7zm8-6h6v9H9V1zm0 11h6v3H9v-3z" />
      </symbol>
      <symbol id="db-storage" viewBox="0 0 16 16">
      ...
      <symbol id="device-mobile" viewBox="0 0 16 16">
        <path d="M3 0v16h10V0H3zm5 15c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1zm4-3H4V2h8v10z" />
      </symbol>
      <symbol id="device-soft-phone" viewBox="0 0 16 16">
      ...
      <symbol id="device-sprint-phone" viewBox="0 0 16 16">
      ...
      <symbol id="device-tablet" viewBox="0 0 16 16">
        <path d="M0 15h16V1H0v14zm15-7c0 .6-.4 1-1 1s-1-.4-1-1 .4-1 1-1 1 .4 1 1zm-3-6v12H2V2h10z" />
      </symbol>
      <symbol id="device-voip-phone" viewBox="0 0 16 16">
      ...
      <symbol id="ear" viewBox="0 0 16 16">
      ...
      <symbol id="ellipses" viewBox="0 0 16 16">
      ...
      <symbol id="extension" viewBox="0 0 16 16">
      ...
      <symbol id="failover" viewBox="0 0 16 16">
      ...
      <symbol id="file-o" viewBox="0 0 16 16">
      ...
      <symbol id="folder-group" viewBox="0 0 16 16">
        <path d="M9.8 3l-1-2H1.9v1H8l1 2h6v8h1V3z" />
        <path d="M8 5L7 3H0v11h14V5H8z" />
      </symbol>
      <symbol id="folder-minus" viewBox="0 0 16 16">
      ...
      <symbol id="folder-star" viewBox="0 0 16 16">
      ...
      <symbol id="headphones-slash" viewBox="0 0 16 16">
      ...
      <symbol id="info--circle-o" viewBox="0 0 16 16">
        <path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zM8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
      ...
      <symbol id="ip-address" viewBox="0 0 16 16">
      ...
      <symbol id="layers--2" viewBox="0 0 16 16">
        <path d="M8 11.5L2.5 8.8 0 10l8 4 8-4-2.5-1.2z" />
        <path d="M16 6L8 2 0 6l8 4z" />
      </symbol>
      <symbol id="layers--3" viewBox="0 0 16 16">
      ...
      <symbol id="lightbulb-slash" viewBox="0 0 16 16">
      ...
      <symbol id="lightning-bolt" viewBox="0 0 16 16">
      ...
      <symbol id="list-prioritize" viewBox="0 0 16 16">
      ...
      <symbol id="location-scope" viewBox="0 0 16 16">
      ...
      <symbol id="lock-open" viewBox="0 0 16 16">
      ...
      <symbol id="main-office" viewBox="0 0 16 16">
      ...
      <symbol id="mic-slash" viewBox="0 0 16 16">
      ...
      <symbol id="minus--circle-o" viewBox="0 0 16 16">
      ...
      <symbol id="move-file" viewBox="0 0 16 16">
      ...
      <symbol id="multiple-items" viewBox="0 0 16 16">
        <path d="M12 3H3v10h1.5V4.5H12z" />
        <path d="M9 0H0v10h1.5V1.5H9zM6 6h9v10H6z" />
      </symbol>
      <symbol id="music-note" viewBox="0 0 16 16">
      ...
      <symbol id="num-pad" viewBox="0 0 16 16">
      ...
      <symbol id="number" viewBox="0 0 16 16">
      ...
      <symbol id="phone-answer" viewBox="0 0 16 16">
      ...
      <symbol id="phone-hangup" viewBox="0 0 16 16">
        <path d="M13 11.1l-1.4-1.5L9 12.1V6H7v6.2L4.4 9.6 3 11.1l3.6 3.5L8 16l1.4-1.4z" />
        <path d="M8.3 2c1.8 0 2.9.7 2.9.9l.3 2.1 2.8 1.4s.3.1.4.1c.2 0 1.3-.8 1.3-1.9C16 1.9 14.9 0 8.2 0h-.4C1.1 0 0 1.9 0 4.6c0 1 1.2 1.9 1.3 1.9s.4-.1.4-.1L4.5 5 5 2.9C5 2.7 6.2 2 7.9 2h.4z" />
      </symbol>
      <symbol id="phone-inbound" viewBox="0 0 16 16">
      ...
      <symbol id="phone-missed" viewBox="0 0 16 16">
      ...
      <symbol id="phone-outbound" viewBox="0 0 16 16">
      ...
      <symbol id="phone-slash" viewBox="0 0 16 16">
      ...
      <symbol id="pie-chart--25" viewBox="0 0 16 16">
        <path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zM8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
        <path d="M8 3.5c-2.5 0-4.5 2-4.5 4.5H8V3.5z" />
      </symbol>
      <symbol id="pie-chart--50" viewBox="0 0 16 16">
        <path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zM8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
        <path d="M8 3.5c-2.5 0-4.5 2-4.5 4.5s2 4.5 4.5 4.5v-9z" />
      </symbol>
      <symbol id="pie-chart--75" viewBox="0 0 16 16">
        <path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zM8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
        <path d="M8 3.5c-2.5 0-4.5 2-4.5 4.5s2 4.5 4.5 4.5 4.5-2 4.5-4.5H8V3.5z" />
      </symbol>
      <symbol id="pie-chart--100" viewBox="0 0 16 16">
        <path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zM8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
        <circle cx={8} cy={8} r={4.5} />
      </symbol>
      <symbol id="play--circle-o" viewBox="0 0 16 16">
      ...
      <symbol id="plus--circle-o" viewBox="0 0 16 16">
        <path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zM8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
      ...
      <symbol id="porting" viewBox="0 0 16 16">
      ...
      <symbol id="question--circle-o" viewBox="0 0 16 16">
      ...
      <symbol id="refresh-alt" viewBox="0 0 16 16">
      ...
      <symbol id="setting-cog-double" viewBox="0 0 16 16">
      ...
      <symbol id="setting-cog" viewBox="0 0 16 16">
      ...
      <symbol id="shopping-cart" viewBox="0 0 16 16">
      ...
      <symbol id="speaking" viewBox="0 0 16 16">
      ...
      <symbol id="stop--circle" viewBox="0 0 16 16">
      ...
      <symbol id="trash-x" viewBox="0 0 16 16">
      ...
      <symbol id="upload-cloud" viewBox="0 0 16 16">
      ...
      <symbol id="user-group" viewBox="0 0 16 16">
      ...
      <symbol id="user-plus" viewBox="0 0 16 16">
        <circle cx={8} cy={4} r={4} />
      ...
      <symbol id="volume-slash" viewBox="0 0 16 16">
        <path d="M14.2 2.8C15.3 4.2 16 6 16 8c0 3.8-2.5 7-6 7.9V14c2.5-.9 4.2-3.2 4.2-6 0-1.5-.5-2.8-1.3-3.9l-1.6 1.6c.4.7.7 1.4.7 2.3 0 1.5-.8 2.8-2 3.5V7L8 9v7l-3.5-3.5L1 16l-1-1L15 0l1 1-1.8 1.8zM12 1c-.6-.4-1.3-.7-2-.9V2c.2.1.5.2.7.3L12 1zM8 5V0L3 5H0v6h2l6-6z" />
      </symbol>
      <symbol id="volume-x" viewBox="0 0 16 16">
      ...
      <symbol id="warning--triangle" viewBox="0 0 16 16">
      ...
      <symbol id="x--circle-o" viewBox="0 0 16 16">
        <path d="M8 16c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zM8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
      ...
      <symbol id="x--octagon" viewBox="0 0 16 16">
